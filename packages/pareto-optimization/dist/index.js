...
__export(index_exports, {
  ...
  PARETO_DOMAINS: () => PARETO_DOMAINS,
  ParetoAnalyticsEngine: () => ParetoAnalyticsEngine,
  ParetoOptimizationEngine: () => ParetoOptimizationEngine,
  ParetoUtils: () => ParetoUtils,
  Q1_2025_ROADMAP: () => Q1_2025_ROADMAP,
  RISK_MITIGATION: () => RISK_MITIGATION,
  RevenueForecastEngine: () => RevenueForecastEngine,
  SUCCESS_METRICS: () => SUCCESS_METRICS,
  calculateImplementationProgress: () => calculateImplementationProgress,
  createParetoOptimization: () => createParetoOptimization,
  generateParetoReport: () => generateParetoReport,
  getNextPriorityTasks: () => getNextPriorityTasks,
  updateTaskStatus: () => updateTaskStatus,
  validateParetoCompliance: () => validateParetoCompliance
});
module.exports = __toCommonJS(index_exports);

// src/types/domain.ts
var import_zod = require("zod");
var DomainPrioritySchema = import_zod.z.enum(["CRITICAL", "HIGH", "SUPPORTING", "EMERGING"]);
var EffortLevelSchema = import_zod.z.enum(["LOW", "MEDIUM", "HIGH"]);
var RevenueTypeSchema = import_zod.z.enum([
  "AFFILIATE",
  "SUBSCRIPTION",
  "E_COMMERCE",
  "CONSULTING",
