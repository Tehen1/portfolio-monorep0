...
import { authValidation, handleValidationErrors, generateToken } from '../middleware/auth.js';
 ...
 */
router.post('/login', authValidation.login, handleValidationErrors, async (req: Request, res: Response) => {
  try {
 ...
 * Register new user
 */
router.post('/register', authValidation.register, handleValidationErrors, async (req: Request, res: Response) => {
  try {
